    ...
    public final class Results {
        ...
        public func forEachRow(callback: (Element) -> ()) -> Bool {
            ...
            for i in 0..<numFields {
                ...
                let fieldName = f.name.withMemoryRebound(to: UInt8.self, capacity: Int(f.name_length)) { UTF8Encoding.encode(generator: GenerateFromPointer(from: $0, count: Int(f.name_length))) }
